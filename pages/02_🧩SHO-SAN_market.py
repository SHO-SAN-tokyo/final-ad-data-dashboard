# 02_🧩SHO-SAN_market.py   ★plot_df.empty を property 参照に修正
...
with c0:
    foc_sel = st.selectbox(
        "フォーカスレベル",
        ["すべて"] + sorted(merged["focus_level"].dropna().unique())
    )
with c1:
