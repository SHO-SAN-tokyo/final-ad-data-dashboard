...
# デバッグ: caption_df の列名を確認
st.subheader("デバッグ: caption_df の列名")
st.write(caption_df.columns)

# デバッグ: caption_df の内容を先頭から表示
st.subheader("デバッグ: caption_df の内容 (head)")
st.dataframe(caption_df.head())
...
st.subheader("デバッグ: マージ後 merged_img_df の列名")
st.write(merged_img_df.columns)
